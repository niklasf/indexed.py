...
class IndexedOrderedDict(dict):
    ...
    def __reversed__(self):
        ...
        return self.__map.__reversed__()
    ...
    def move_to_end(self, key, last=True):
        ...
        if last:
            ...
            self.__map.insert(0, key)

    def __sizeof__(self):
        return sys.getsizeof(self.__dict__) + sys.getsizeof(self.__map)

    update = __update = collections.MutableMapping.update
    keys = collections.MutableMapping.keys # TODO: Replace
